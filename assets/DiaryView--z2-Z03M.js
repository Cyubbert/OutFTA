import{_ as T,H as S,J as H,c as o,b as u,w as c,z as m,o as i,a as e,t as n,x as w,q as l,F as y,d as f,m as g,s as x}from"./index-D0iA8MAb.js";const M={class:"diary-root"},A={key:0,class:"diary-detail"},W={class:"detail-header"},C={class:"detail-session"},q={class:"detail-title"},R={class:"detail-meta"},F={class:"detail-date"},Q={class:"detail-location"},N={key:0,class:"detail-images"},B=["src","alt"],O={class:"detail-body"},j={key:1,class:"detail-highlights"},D={class:"hl-list"},z={key:0,class:"diary-list"},P={class:"entries"},V=["onClick"],E={class:"entry-left"},G={class:"entry-session"},$={class:"entry-right"},U={class:"entry-top-row"},J={class:"entry-date"},L={class:"entry-location"},Y={class:"entry-title"},K={class:"entry-preview"},X=["src"],Z={__name:"DiaryView",setup(ee){S(()=>{document.body.style.backgroundColor="#f5f0e8",document.body.style.color="#1a1008",document.body.style.maxWidth="100%",document.body.style.margin="0",document.body.style.padding="0";const r=document.querySelector(".navbar");r&&(r.style.display="none")}),H(()=>{document.body.style.backgroundColor="",document.body.style.color="",document.body.style.maxWidth="",document.body.style.margin="",document.body.style.padding="";const r=document.querySelector(".navbar");r&&(r.style.display="")});const b=g([{id:1,session:1,title:"01 - Arrival in Halivaara",date:"2026-03-29",location:"Halivaara",mood:"neutral",images:["/images/mory_s1.png"],body:`˖⁺‧₊˚ O, câine mereu atent, ascultă rugăciunea credincioșilor tăi˚₊‧⁺˖
