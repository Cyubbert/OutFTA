import{_ as S,H as _,J as M,c as o,b as m,w as u,z as c,o as i,a as e,t as s,x as b,q as l,F as y,d as g,m as f,s as A}from"./index-BYQw_Oed.js";const x={class:"diary-root"},H={key:0,class:"diary-detail"},W={class:"detail-header"},q={class:"detail-session"},N={class:"detail-title"},Q={class:"detail-meta"},P={class:"detail-date"},R={class:"detail-location"},C={key:0,class:"detail-images"},F=["src","alt"],O={class:"detail-body"},B={key:1,class:"detail-highlights"},j={class:"hl-list"},D={key:0,class:"diary-list"},E={class:"entries"},U=["onClick"],V={class:"entry-left"},z={class:"entry-session"},G={class:"entry-right"},L={class:"entry-top-row"},$={class:"entry-date"},Y={class:"entry-location"},J={class:"entry-title"},K={class:"entry-preview"},X=["src"],Z={__name:"DiaryView",setup(ee){_(()=>{document.body.style.backgroundColor="#f5f0e8",document.body.style.color="#1a1008",document.body.style.maxWidth="100%",document.body.style.margin="0",document.body.style.padding="0";const r=document.querySelector(".navbar");r&&(r.style.display="none")}),M(()=>{document.body.style.backgroundColor="",document.body.style.color="",document.body.style.maxWidth="",document.body.style.margin="",document.body.style.padding="";const r=document.querySelector(".navbar");r&&(r.style.display="")});const v=f([{id:1,session:1,title:"01 - Arrival in Halivaara",date:"2026-03-29",location:"Halivaara",mood:"neutral",images:["/images/mory_s1.png"],body:`˖⁺‧₊˚ ᒷ⍊ᒷ∷ ∴ᔑℸ ̣ ᓵ⍑⎓⚍ꖎ ↸𝙹⊣, ꖎ╎ᓭℸ ̣ ᒷリ ℸ ̣ 𝙹 ℸ ̣ ⍑ᒷ !¡∷ᔑ||ᒷ∷ 𝙹⎓ ||𝙹⚍∷ ⎓ᔑ╎ℸ ̣ ⍑⎓⚍ꖎ˚₊‧⁺˖
...
Panic took hold when lightning struck the suspended body. Birds fell, lifeless strewn across the streets.
...
We later crossed the water to the fisherman's hut. Sir Nathaniel and Miss Raya spoke with the red thread's father and learned of a pendant the woman wore, a ribcage, of all things. A detail worth remembering.

For now, we have returned to the tavern to rest and prepare. Tomorrow may offer clarity.

I will be sharing a room with Miss Raya and Sir Quinlan.

˖⁺‧₊˚ᒲᔑ|| ᒲ|| ᒲ╎ᓭᓭ𝙹リ ʖᒷᔑ∷ ⎓∷⚍╎ℸ ̣ ᓭ, ᒲ|| ∷ᒷℸ ̣ ⚍∷リ ||𝙹⚍ ᓭ⍑ᔑꖎꖎ ᔑ∴ᔑ╎ℸ ̣ ˚₊‧⁺˖`,highlights:["Arrival in Halivaara","Divine Intervention","Meeting a Group"]},{id:2,session:2,title:"02 - The Ill",date:"2026-05-9",location:"Halivaara",mood:"Hungry",images:["/images/mory_s2.png"],body:`⁺‧₊˚ ᒷ⍊ᒷ∷ ∴ᔑℸ ̣ ᓵ⍑⎓⚍ꖎ ↸𝙹⊣, ꖎ╎ᓭℸ ̣ ᒷリ ℸ ̣ 𝙹 ℸ ̣ ⍑ᒷ !¡∷ᔑ||ᒷ∷ 𝙹⎓ ||𝙹⚍∷ ⎓ᔑ╎ℸ ̣ ⍑⎓⚍ꖎ˚₊‧⁺˖
...
˖⁺‧₊˚ᒲᔑ|| ᒲ|| ᒲ╎ᓭᓭ𝙹リ ʖᒷᔑ∷ ⎓∷⚍╎ℸ ̣ ᓭ, ᒲ|| ∷ᒷℸ ̣ ⚍∷リ ||𝙹⚍ ᓭ⍑ᔑꖎꖎ ᔑ∴ᔑ╎ℸ ̣ ˚₊‧⁺˖`,highlights:["Roaming in Halivaara","Kitchen worker caught the Ill","Finding a job"]},{id:3,session:3,title:"03 - Knowledge comes with Responsibility",date:"2026-06-01",location:"Halivaara",mood:"melancholy",images:["/images/mory_s3.png"],body:`˖⁺‧₊˚ ᒷ⍊ᒷ∷ ∴ᔑℸ ̣ ᓵ⍑⎓⚍ꖎ ↸𝙹⊣, ꖎ╎ᓭℸ ̣ ᒷリ ℸ ̣ 𝙹 ℸ ̣ ⍑ᒷ !¡∷ᔑ||ᒷ∷ 𝙹⎓ ||𝙹⚍∷ ⎓ᔑ╎ℸ ̣ ⍑⎓⚍ꖎ˚₊‧⁺˖
...
˖⁺‧₊˚ᒲᔑ|| ᒲ|| ᒲ╎ᓭᓭ𝙹リ ʖᒷᔑ∷ ⎓∷⚍╎ℸ ̣ ᓭ, ᒲ|| ∷ᒷℸ ̣ ⚍∷リ ||𝙹⚍ ᓭ⍑ᔑꖎꖎ ᔑ∴ᔑ╎ℸ ̣  Rest well, my dear.˚₊‧⁺˖`,highlights:["Vampires","Strange Hound"]}]),d=f(null),n=f(null),I=A(()=>[...v.value].sort((r,t)=>t.session-r.session));function k(r){n.value=r,window.scrollTo({top:0,behavior:"smooth"})}function p(){n.value=null}const T={anxious:"#c0392b",hopeful:"#e8d5b0",angry:"#8b0000",melancholy:"#a09080",determined:"#c0392b",broken:"#555",triumphant:"#e8d5b0",neutral:"#9a8878"};function h(r){return T[r]||"#c0392b"}return(r,t)=>(i(),o("div",x,[m(c,{name:"page-slide"},{default:u(()=>[n.value?(i(),o("div",H,[e("button",{class:"back-btn",onClick:p},"← Back"),e("div",W,[e("div",q,"Session "+s(n.value.session),1),e("h1",N,s(n.value.title),1),e("div",Q,[e("span",P,s(n.value.date),1),t[3]||(t[3]=e("span",{class:"detail-sep"},"·",-1)),e("span",R,s(n.value.location),1),n.value.mood?(i(),o("span",{key:0,class:"detail-mood",style:b({color:h(n.value.mood),borderColor:h(n.value.mood)+"44"})},s(n.value.mood),5)):l("",!0)]),t[4]||(t[4]=e("div",{class:"detail-rule"},null,-1))]),n.value.images?.length?(i(),o("div",C,[e("img",{src:n.value.images[0],alt:n.value.title,class:"detail-img single",onClick:t[0]||(t[0]=a=>d.value=n.value.images[0])},null,8,F)])):l("",!0),e("div",O,[(i(!0),o(y,null,g(n.value.body.split(`

`).filter(a=>a.trim()),(a,w)=>(i(),o("p",{key:w,class:"detail-para"},s(a.trim()),1))),128))]),n.value.highlights?.length?(i(),o("div",B,[t[5]||(t[5]=e("div",{class:"hl-label"},"— notable —",-1)),e("ul",j,[(i(!0),o(y,null,g(n.value.highlights,a=>(i(),o("li",{key:a},s(a),1))),128))])])):l("",!0),e("div",{class:"detail-footer"},[t[6]||(t[6]=e("div",{class:"detail-rule"},null,-1)),e("button",{class:"back-btn-bottom",onClick:p},"← All Entries")])])):l("",!0)]),_:1}),m(c,{name:"page-slide"},{default:u(()=>[n.value?l("",!0):(i(),o("div",D,[t[9]||(t[9]=e("header",{class:"diary-header"},[e("div",{class:"diary-mark"},"✦"),e("h1",{class:"diary-title"},"Morythieven's Journal"),e("p",{class:"diary-subtitle"},"Prayer's for my dear Hound"),e("div",{class:"header-rule"})],-1)),e("div",E,[(i(!0),o(y,null,g(I.value,a=>(i(),o("div",{key:a.id,class:"entry-card",onClick:w=>k(a)},[e("div",V,[e("div",z,"S"+s(String(a.session).padStart(2,"0")),1),t[7]||(t[7]=e("div",{class:"entry-line"},null,-1))]),e("div",G,[e("div",L,[e("span",$,s(a.date),1),e("span",Y,s(a.location),1),a.mood?(i(),o("span",{key:0,class:"entry-mood",style:b({color:h(a.mood)})},s(a.mood),5)):l("",!0)]),e("h2",J,s(a.title),1),e("p",K,s(a.body.replace(/\n/g," ").slice(0,120).trim())+"…",1),t[8]||(t[8]=e("div",{class:"entry-read"},"read →",-1))])],8,U))),128))])]))]),_:1}),m(c,{name:"lb"},{default:u(()=>[d.value?(i(),o("div",{key:0,class:"lb-backdrop",onClick:t[2]||(t[2]=a=>d.value=null)},[e("img",{src:d.value,class:"lb-img"},null,8,X),e("button",{class:"lb-close",onClick:t[1]||(t[1]=a=>d.value=null)},"✕")])):l("",!0)]),_:1})]))}},ae=S(Z,[["__scopeId","data-v-eaead554"]]);export{ae as default};
