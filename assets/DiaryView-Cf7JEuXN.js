import{_ as S,H as _,J as M,c as o,b as m,w as u,z as c,o as i,a as e,t as s,x as b,q as l,F as y,d as g,m as f,s as A}from"./index-jz1ZOi43.js";const x={class:"diary-root"},H={key:0,class:"diary-detail"},W={class:"detail-header"},q={class:"detail-session"},N={class:"detail-title"},Q={class:"detail-meta"},P={class:"detail-date"},R={class:"detail-location"},C={key:0,class:"detail-images"},F=["src","alt"],O={class:"detail-body"},B={key:1,class:"detail-highlights"},j={class:"hl-list"},D={key:0,class:"diary-list"},E={class:"entries"},U=["onClick"],V={class:"entry-left"},z={class:"entry-session"},G={class:"entry-right"},L={class:"entry-top-row"},$={class:"entry-date"},Y={class:"entry-location"},J={class:"entry-title"},K={class:"entry-preview"},X=["src"],Z={__name:"DiaryView",setup(ee){_(()=>{document.body.style.backgroundColor="#f5f0e8",document.body.style.color="#1a1008",document.body.style.maxWidth="100%",document.body.style.margin="0",document.body.style.padding="0";const r=document.querySelector(".navbar");r&&(r.style.display="none")}),M(()=>{document.body.style.backgroundColor="",document.body.style.color="",document.body.style.maxWidth="",document.body.style.margin="",document.body.style.padding="";const r=document.querySelector(".navbar");r&&(r.style.display="")});const v=f([{id:1,session:1,title:"01 - Arrival in Halivaara",date:"2026-03-29",location:"Halivaara",mood:"neutral",images:["/images/mory_s1.png"],body:`˖ ᒷ⍊ᒷ∷ ∴ᔑℸ ̣ ᓵ⍑⎓⚍ꖎ ↸𝙹⊣, ꖎ╎ᓭℸ ̣ ᒷリ ℸ ̣ 𝙹 ℸ ̣ ⍑ᒷ !¡∷ᔑ||ᒷ∷ 𝙹⎓ ||𝙹⚍∷ ⎓ᔑ╎ℸ ̣ ⍑⎓⚍ꖎ
