import{_ as T,H as S,J as H,c as o,b as u,w as c,z as m,o as i,a as e,t as n,x as w,q as l,F as y,d as f,m as g,s as x}from"./index-CDFNmIC1.js";const M={class:"diary-root"},A={key:0,class:"diary-detail"},W={class:"detail-header"},C={class:"detail-session"},q={class:"detail-title"},R={class:"detail-meta"},F={class:"detail-date"},Q={class:"detail-location"},N={key:0,class:"detail-images"},B=["src","alt"],O={class:"detail-body"},j={key:1,class:"detail-highlights"},D={class:"hl-list"},z={key:0,class:"diary-list"},P={class:"entries"},V=["onClick"],E={class:"entry-left"},G={class:"entry-session"},$={class:"entry-right"},U={class:"entry-top-row"},J={class:"entry-date"},L={class:"entry-location"},Y={class:"entry-title"},K={class:"entry-preview"},X=["src"],Z={__name:"DiaryView",setup(ee){S(()=>{document.body.style.backgroundColor="#f5f0e8",document.body.style.color="#1a1008",document.body.style.maxWidth="100%",document.body.style.margin="0",document.body.style.padding="0";const r=document.querySelector(".navbar");r&&(r.style.display="none")}),H(()=>{document.body.style.backgroundColor="",document.body.style.color="",document.body.style.maxWidth="",document.body.style.margin="",document.body.style.padding="";const r=document.querySelector(".navbar");r&&(r.style.display="")});const b=g([{id:1,session:1,title:"01 - Arrival in Halivaara",date:"2026-03-29",location:"Halivaara",mood:"neutral",images:["/images/mory_s1.png"],body:`˖⁺‧₊˚ O, câine mereu atent, ascultă rugăciunea credincioșilor tăi˚₊‧⁺˖
...
˖⁺‧₊˚Fie ca misiunea mea să dea roade, întoarcerea mea o vei aștepta. Rest well, my dear.˚₊‧⁺˖`,highlights:["Arrival in Halivaara","Divine Intervention","Meeting a Group"]},{id:2,session:2,title:"02 - The Ill",date:"2026-05-9",location:"Halivaara",mood:"Hungry",images:["/images/mory_s2.png"],body:`⁺‧₊˚ O, câine mereu atent, ascultă rugăciunea credincioșilor tăi˚₊‧⁺˖
...
˖⁺‧₊˚Fie ca misiunea mea să dea roade, întoarcerea mea o vei aștepta˚₊‧⁺˖`,highlights:["Roaming in Halivaara","Kitchen worker caught the Ill","Finding a job"]}]),d=g(null),s=g(null),k=x(()=>[...b.value].sort((r,t)=>t.session-r.session));function I(r){s.value=r,window.scrollTo({top:0,behavior:"smooth"})}function p(){s.value=null}const _={anxious:"#c0392b",hopeful:"#e8d5b0",angry:"#8b0000",melancholy:"#a09080",determined:"#c0392b",broken:"#555",triumphant:"#e8d5b0",neutral:"#9a8878"};function h(r){return _[r]||"#c0392b"}return(r,t)=>(i(),o("div",M,[u(m,{name:"page-slide"},{default:c(()=>[s.value?(i(),o("div",A,[e("button",{class:"back-btn",onClick:p},"← Back"),e("div",W,[e("div",C,"Session "+n(s.value.session),1),e("h1",q,n(s.value.title),1),e("div",R,[e("span",F,n(s.value.date),1),t[3]||(t[3]=e("span",{class:"detail-sep"},"·",-1)),e("span",Q,n(s.value.location),1),s.value.mood?(i(),o("span",{key:0,class:"detail-mood",style:w({color:h(s.value.mood),borderColor:h(s.value.mood)+"44"})},n(s.value.mood),5)):l("",!0)]),t[4]||(t[4]=e("div",{class:"detail-rule"},null,-1))]),s.value.images?.length?(i(),o("div",N,[e("img",{src:s.value.images[0],alt:s.value.title,class:"detail-img single",onClick:t[0]||(t[0]=a=>d.value=s.value.images[0])},null,8,B)])):l("",!0),e("div",O,[(i(!0),o(y,null,f(s.value.body.split(`

`).filter(a=>a.trim()),(a,v)=>(i(),o("p",{key:v,class:"detail-para"},n(a.trim()),1))),128))]),s.value.highlights?.length?(i(),o("div",j,[t[5]||(t[5]=e("div",{class:"hl-label"},"— notable —",-1)),e("ul",D,[(i(!0),o(y,null,f(s.value.highlights,a=>(i(),o("li",{key:a},n(a),1))),128))])])):l("",!0),e("div",{class:"detail-footer"},[t[6]||(t[6]=e("div",{class:"detail-rule"},null,-1)),e("button",{class:"back-btn-bottom",onClick:p},"← All Entries")])])):l("",!0)]),_:1}),u(m,{name:"page-slide"},{default:c(()=>[s.value?l("",!0):(i(),o("div",z,[t[9]||(t[9]=e("header",{class:"diary-header"},[e("div",{class:"diary-mark"},"✦"),e("h1",{class:"diary-title"},"Morythieven's Journal"),e("p",{class:"diary-subtitle"},"Prayer's for my dear Hound"),e("div",{class:"header-rule"})],-1)),e("div",P,[(i(!0),o(y,null,f(k.value,a=>(i(),o("div",{key:a.id,class:"entry-card",onClick:v=>I(a)},[e("div",E,[e("div",G,"S"+n(String(a.session).padStart(2,"0")),1),t[7]||(t[7]=e("div",{class:"entry-line"},null,-1))]),e("div",$,[e("div",U,[e("span",J,n(a.date),1),e("span",L,n(a.location),1),a.mood?(i(),o("span",{key:0,class:"entry-mood",style:w({color:h(a.mood)})},n(a.mood),5)):l("",!0)]),e("h2",Y,n(a.title),1),e("p",K,n(a.body.replace(/\n/g," ").slice(0,120).trim())+"…",1),t[8]||(t[8]=e("div",{class:"entry-read"},"read →",-1))])],8,V))),128))])]))]),_:1}),u(m,{name:"lb"},{default:c(()=>[d.value?(i(),o("div",{key:0,class:"lb-backdrop",onClick:t[2]||(t[2]=a=>d.value=null)},[e("img",{src:d.value,class:"lb-img"},null,8,X),e("button",{class:"lb-close",onClick:t[1]||(t[1]=a=>d.value=null)},"✕")])):l("",!0)]),_:1})]))}},ae=T(Z,[["__scopeId","data-v-6ec11c79"]]);export{ae as default};
